...
{
    private $conn;
    private const TABLA = "subcategorias";

    public $id_subcategoria;
    public $descripcion_subcategoria;
    public $id_categoria;
    public $fecha_creacion_subcategoria;
    public $fecha_modificacion_subcategoria;
    ...
    // Metodo para obtener una subcategoria por ID
    public function obtenerPorId($id)
    {
        $query = "SELECT * FROM " . self::TABLA . " WHERE id_subcategoria = :id_subcategoria LIMIT 1";
        $params = [':id_subcategoria' => $id];
        return $this->ejecutarConsulta($query, $params, true);
    }

    // Metodo para obtener subcategorias paginadas con filtros
    public function obtenerSubcategorias($limit = 10, $offset = 0, $filtros = [])
    {
    ...
    {
        $this->sanitizarDatos();
        $query = "INSERT INTO " . self::TABLA . " (descripcion_subcategoria, id_categoria) VALUES (:descripcion_subcategoria, :id_categoria)";
        $params = [
    ...
    // Metodo para actualzar una subcategoria
    public function actualizar()
    {
        $this->sanitizarDatos();
        $query = "UPDATE " . self::TABLA . " SET descripcion_subcategoria = :descripcion_subcategoria, id_categoria = :id_categoria WHERE id_subcategoria = :id_subcategoria";
        $params = [
    ...
    {
        $query = "DELETE FROM " . self::TABLA . " WHERE id_subcategoria = :id_subcategoria";
        $params = [':id_subcategoria' => $this->id_subcategoria];
        return $this->ejecutarConsulta($query, $params);
    }
    ...
    private function construirClausulasWhere($filtros)
    {
        ...
        if (!empty($filtros['fecha_creacion_subcategoria'])) {
            $filtros['fecha_inicio_creacion'] = $filtros['fecha_creacion_subcategoria'] . " 00:00:00";
            $filtros['fecha_fin_creacion'] = $filtros['fecha_creacion_subcategoria'] . " 23:59:59";
            $whereClauses[] = "fecha_creacion_subcategoria BETWEEN :fecha_inicio_creacion AND :fecha_fin_creacion";
            ...
            $whereClauses[] = "fecha_creacion_subcategoria BETWEEN :fecha_creacion_desde AND :fecha_creacion_hasta";
            $params[':fecha_creacion_desde'] = $filtros['fecha_creacion_desde'];
            $params[':fecha_creacion_hasta'] = $filtros['fecha_creacion_hasta'];
        }

        // Filtrar por fecha de modificación
        if (!empty($filtros['fecha_modificacion_subcategoria'])) {
            $filtros['fecha_inicio_modificacion'] = $filtros['fecha_modificacion_subcategoria'] . " 00:00:00";
            $filtros['fecha_fin_modificacion'] = $filtros['fecha_modificacion_subcategoria'] . " 23:59:59";
            $whereClauses[] = "fecha_modificacion_subcategoria BETWEEN :fecha_inicio_modificacion AND :fecha_fin_modificacion";
            ...
            $whereClauses[] = "fecha_modificacion_subcategoria BETWEEN :fecha_modificacion_desde AND :fecha_modificacion_hasta";
        ...
        foreach ($filtros as $campo => $valor) {
            if (!in_array($campo, [
                'fecha_creacion_subcategoria',
                'fecha_creacion_desde',
                'fecha_creacion_hasta',
                'fecha_inicio_creacion',
                'fecha_fin_creacion',
                'fecha_modificacion_subcategoria',
